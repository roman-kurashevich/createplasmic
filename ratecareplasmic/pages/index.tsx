    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/signin"><a style={{ color: "blue" }}>SignIn - /signin</a></Link></li>
<li><Link href="/enter-code"><a style={{ color: "blue" }}>EnterCode - /enter-code</a></Link></li>
<li><Link href="/home-page"><a style={{ color: "blue" }}>HomePage - /home-page</a></Link></li>
<li><Link href="/appointment"><a style={{ color: "blue" }}>Appointment - /appointment</a></Link></li>
<li><Link href="/confirmed"><a style={{ color: "blue" }}>Confirmed - /confirmed</a></Link></li>
