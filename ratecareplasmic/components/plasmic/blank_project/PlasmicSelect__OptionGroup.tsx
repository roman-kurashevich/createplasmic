...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 0Brg5ub9P_Z/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: L6Ve5SKzB5v/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__e93Qc)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__wr8Nh)}
              />
            </React.Fragment>
          ),
          value: args.children
