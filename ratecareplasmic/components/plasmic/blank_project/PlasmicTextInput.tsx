...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: OyG8vtv76jp/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: kp0PTEsCV1_/icon
      ...
      Object.assign(
        {
          ...
          name: "Phone number" as const,
          required: true,
          "aria-label": "Phone number" as const,
          "aria-labelledby": "Phone number" as const
        },
        props.args
      ),
    [props.args]
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___1Lxf)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__fYsDg)}
                role={"img"}
              />
            ),
